/**
 * Image which preserves the aspect ratio while scaling the image and constrains * the dimensions to stay within the min/max width/height. The image is placed
 ...
 * by John Spackman-3
 */
qx.Class.define("lib.ui.image.Image", {
